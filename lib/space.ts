...
export const ROOMS: SpaceRoom[] = [
    ...
    equipment: [
      {
        title: "기본 안내",
        items: [
          "평일 09:00~18:00 / 화 야간 18:00~20:00 / 토 09:00~13:00 / 일 휴관",
          "일요일은 자동 제외됩니다.",
          "공휴일은 자동 제외하지 않으며(차단시간 설정으로 관리)",
          "준비(세팅)일 1일 무료: 전시 시작일 이전(휴관일 제외)",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    contactName: "관리자",
    contactPhone: "02-0000-0000",
    note: "촬영·녹음·편집 등 미디어 활동을 지원하는 스튜디오 공간입니다.",
    equipment: [
      { title: "기본 비치", items: ["테이블", "의자", "전원(콘센트)", "냉·난방", "조명"] },
      { title: "기자재(운영 상황에 따라 제공)", items: ["촬영/녹음 장비는 대관 목적 및 운영 상황에 따라 제공 범위가 달라질 수 있습니다."] },
      { title: "이용 유의", items: ["장비 사용이 필요한 경우 사전 협의 및 사용 안내에 따라 이용해 주시기 바랍니다."] },
    ],
  },
  {
    id: "it",
